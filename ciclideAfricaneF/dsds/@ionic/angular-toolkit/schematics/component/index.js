...
function default_1(options) {
    return async (host) => {
        ...
        options.selector = options.selector ? options.selector : util_1.buildSelector(options, (_a = project === null || project === void 0 ? void 0 : project.prefix) !== null && _a !== void 0 ? _a : 'app');
