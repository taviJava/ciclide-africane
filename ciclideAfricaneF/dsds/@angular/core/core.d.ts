...
/**
 * Creates and initializes a custom renderer that implements the `Renderer` base class.
 *
 * @publicApi
 */
export declare abstract class RendererFactory2 {
     ...
     */
    abstract createRenderer(hostElement: any, type: RendererType2 | null): Renderer;
    /**
...
/** Injects a Renderer for the current component. */
export declare function ɵangular_packages_core_core_h(): Renderer;
...
export declare const ɵSWITCH_Renderer_FACTORY__POST_R3__: typeof ɵangular_packages_core_core_h;
